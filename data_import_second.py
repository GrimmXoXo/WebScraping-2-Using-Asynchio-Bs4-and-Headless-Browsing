...
def get_data(links):
    '''Input links of the Details page, Second data_import_second is used to extract information from some pages using XPATH as the labelling of HTML was unstructured'''
    global request
    ...
    for link in links:
        ...
        try:
            ...
            lists_to_iterate = [All_Facilities.copy(), location.copy(), Building_Name.copy(), Builder_Name.copy(),
                                location_advantages.copy(),
    ...
    existing_data.extend(property_data_list)
    ...
    print('New data has been added to data.json')
...
if __name__ == '__main__':
    ...
    if os.path.exists(file):
        ...
        print('Get the url file from json_extract.py')
